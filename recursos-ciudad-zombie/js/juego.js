...
var Juego = {
    ...
    obstaculosCarretera: [
        /*Aca se van a agregar los obstaculos visibles. Tenemos una valla 
        horizontal
        de ejemplo, pero podras agregar muchos mas. */
        new Obstaculo('imagenes/valla_horizontal.png', 140, 80, 30, 30, 1),
        new Obstaculo('imagenes/valla_horizontal.png', 170, 80, 30, 30, 1),
        new Obstaculo('imagenes/auto_verde_abajo.png', 180, 230, 15, 30, 1),
        new Obstaculo('imagenes/bache.png', 170, 280, 30, 30, 1),
    ...
    enemigos: [
        ...
        new ZombieCaminante('imagenes/zombie2.png', 600, 300, 10, 10, 1, {
            desdeX: 0,
            hastaX: 961,
            desdeY: 0,
            hastaY: 577
        }),
        new ZombieCaminante('imagenes/zombie2.png', 700, 230, 10, 10, 1, {
            desdeX: 0,
            hastaX: 961,
            desdeY: 0,
            hastaY: 577
        ...
        new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 8, { //vertical1
            desdeX: 0,
            hastaX: 961,
            desdeY: -20,
            hastaY: 600,
        }, 'v'),
        new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 6, { //vertical2
            desdeX: 0,
            hastaX: 961,
            desdeY: -15,
            hastaY: 600
        }, 'v'),
        new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 9, {
            desdeX: 0,
            hastaX: 961,
            desdeY: 0,
            hastaY: 577
...
para tener un facil acceso
a ellos. No hace falta comprender esta parte. 
Pero si queres agregar tus propies
imagenes tendras que poner su ruta en la lista 
para que pueda ser precargada como
todas las demas. */
...
Juego.capturarMovimiento = function(tecla) {
    ...
    if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
        /* Aca tiene que estar la logica para mover 
        al jugador invocando alguno
        de sus metodos  */

        /* COMPLETAR */
        this.jugador.mover(movX, movY);

        this.jugador.cambiarImagen(tecla);
    }
};
...
Juego.dibujar = function() {
    ...
    /* Aca hay que agregar la logica para poder
     dibujar al jugador principal
    utilizando al dibujante y los metodos que nos 
    brinda.
    ...
    // Se recorren los obstaculos de la carretera
    // pintandolos
...
un recorrido por los enemigos para dibujarlos 
en pantalla ahora habra que hacer
...
/* Este metodo chequea si los elementos 1 y 2 si cruzan
 en x e y
 x e y representan la coordenada a la cual se quiere
  mover el elemento2*/
